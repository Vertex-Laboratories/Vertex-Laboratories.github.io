(function() {
  ...
  $('.twentytwenty-container').each(function(){
    ...
    $(".chevron .down").click(function() {
      return $('html, body').animate({
        scrollTop: $("#services-1").offset().top
      }, 1500);
    });
    ...
    if ($("html").hasClass("cssanimations") && !mobile) {
      ...
      items = [['.column', 'fadeInUp'], ['.item', 'fadeInDown'], ['.bar', 'fadeInRight'], ['.paperplane', 'bounceInDown'], ['#quote .container', 'fadeIn'], ['#quote .icon', 'fadeInDown']];
