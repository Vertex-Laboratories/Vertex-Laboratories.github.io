!function t(e, i, n) {
    ...
    2: [function(t, e, i) {
        !function(n, r) {
            ...
            "use strict";
            var s, o = "fullpage-wrapper", a = "." + o, l = "fp-scrollable", u = "." + l, c = ".slimScrollBar", h = ".slimScrollRail", f = "fp-responsive", p = "fp-notransition", d = "fp-destroyed", m = "fp-enabled", g = "fp-viewing", _ = "active", v = "." + _, y = ".section", x = "fp-section", b = "." + x, w = b + v, T = b + ":first", S = b + ":last", C = "fp-tableCell", k = "." + C, P = "fp-auto-height", A = "fp-nav", O = "#" + A, R = "fp-tooltip", D = "fp-show-active", E = ".slide", N = "fp-slide", M = "." + N, L = M + v, F = "fp-slides", j = "." + F, q = "fp-slidesContainer", z = "." + q, I = "fp-table", B = "fp-slidesNav", H = "." + B, X = H + " a", W = "fp-controlArrow", Y = "." + W, $ = "fp-prev", U = "." + $, V = W + " " + $, G = Y + U, Q = "fp-next", Z = "." + Q, K = W + " " + Q, J = Y + Z, tt = t(e), et = t(i);
            t.fn.fullpage = function(l) {
                function u() {
                    l.css3 && (l.css3 = Jt()),
                    l.anchors.length || (l.anchors = t("[data-anchor]").map(function() {
                        return t(this).data("anchor").toString()
                    }).get()),
                    c(),
                    ge.setAllowScrolling(!0),
                    Se = tt.height(),
                    ge.setAutoScrolling(l.autoScrolling, "internal");
                    var e = t(w).find(L);
                    e.length && (0 !== t(w).index(b) || 0 === t(w).index(b) && 0 !== e.index()) && oe(e),
                    Dt(),
                    Kt(),
                    tt.on("load", function() {
                        St()
                ...
                function c() {
                    ...
                    t(b).each(function(e) {
                        ...
                        W(i, e),
                        U(i, e),
                        r > 0 ? h(i, n, r) : l.verticalCentered && Bt(i)
                    }),
                    l.fixedElements && l.css3 && t(l.fixedElements).appendTo(me),
                    l.navigation && it(),
                    l.scrollOverflow ? ("complete" === i.readyState && nt(),
                    tt.on("load", nt)) : rt()
                }
                function h(e, i, n) {
                    var r = 100 * n
                      , s = 100 / n;
                    i.wrapAll('<div class="' + q + '" />'),
                    i.parent().wrap('<div class="' + F + '" />'),
                    e.find(z).css("width", r + "%"),
                    n > 1 && (l.controlArrows && Z(e),
                    l.slidesNavigation && Vt(e, n)),
                    i.each(function(e) {
                        t(this).css("width", s + "%"),
                        l.verticalCentered && Bt(t(this))
                    });
                    var o = e.find(L);
                    o.length && (0 !== t(w).index(b) || 0 === t(w).index(b) && 0 !== o.index()) ? oe(o) : i.eq(0).addClass(_)
                }
                function W(e, i) {
                    i || 0 !== t(w).length || e.addClass(_),
                    e.css("height", Se + "px"),
                    l.paddingTop && e.css("padding-top", l.paddingTop),
                    l.paddingBottom && e.css("padding-bottom", l.paddingBottom),
                    "undefined" != typeof l.sectionsColor[i] && e.css("background-color", l.sectionsColor[i]),
                    "undefined" != typeof l.anchors[i] && e.attr("data-anchor", l.anchors[i])
                }
                function U(e, i) {
                    "undefined" != typeof l.anchors[i] && e.hasClass(_) && jt(l.anchors[i], i),
                    l.menu && l.css3 && t(l.menu).closest(a).length && t(l.menu).appendTo(me)
                }
                function Q() {
                ...
                function Z(t) {
                    t.find(j).after('<div class="' + V + '"></div><div class="' + K + '"></div>'),
                    "#fff" != l.controlArrowColor && (t.find(J).css("border-color", "transparent transparent transparent " + l.controlArrowColor),
                    t.find(G).css("border-color", "transparent " + l.controlArrowColor + " transparent transparent")),
                    l.loopHorizontal || t.find(G).hide()
                }
                function it() {
                    ...
                    for (var i = 0; i < t(b).length; i++) {
                        ...
                        "undefined" != typeof s && "" !== s && (r += '<div class="' + R + " " + l.navigationPosition + '">' + s + "</div>"),
                        r += "</li>",
                        e.find("ul").append(r)
                    }
                    t(O).css("margin-top", "-" + t(O).height() / 2 + "px"),
                    t(O).find("li").eq(t(w).index(b)).find("a").addClass(_)
                }
                function nt() {
                    t(b).each(function() {
                        var e = t(this).find(M);
                ...
                function rt() {
                    var e = t(w);
                    l.scrollOverflowHandler.afterRender && l.scrollOverflowHandler.afterRender(e),
                    bt(e),
                    wt(e),
                    t.isFunction(l.afterLoad) && l.afterLoad.call(e, e.data("anchor"), e.index(b) + 1),
                    t.isFunction(l.afterRender) && l.afterRender.call(Te)
                }
                function st() {
                    var e;
                    if (!l.autoScrolling || l.scrollBar) {
                        ...
                        !e.hasClass(_) && !e.hasClass(P)) {
                            ...
                            if (v.length)
                                var y = v.data("anchor")
                                  , x = v.index();
                            Pe && (e.addClass(_).siblings().removeClass(_),
                            t.isFunction(l.onLeave) && l.onLeave.call(f, p, g, d),
                            t.isFunction(l.afterLoad) && l.afterLoad.call(e, m, g),
                            bt(e),
                            jt(m, g - 1),
                            l.anchors.length && (_e = m,
                            Gt(x, y, m, g))),
                            clearTimeout(Ne),
                        ...
                        l.fitToSection && (clearTimeout(Me),
                ...
                function ot(t, e) {
                    if (Oe.m[t]) {
                        var i, n;
                        if ("down" == t ? (i = "bottom",
                        n = ge.moveSectionDown) : (i = "top",
                        n = ge.moveSectionUp),
                        e.length > 0) {
                            if (!l.scrollOverflowHandler.isScrolled(i, e))
                                return !0;
                            n()
                        } else
                            n()
                ...
                function at(e) {
                    ...
                    if (!lt(e.target) && ut(i)) {
                        ...
                        if (Pe && !xe) {
                            ...
                            Ie = o.y,
                            Be = o.x,
                            r.find(j).length && n.abs(ze - Be) > n.abs(qe - Ie) ? n.abs(ze - Be) > tt.width() / 100 * l.touchSensitivity && (ze > Be ? Oe.m.right && ge.moveSlideRight() : Oe.m.left && ge.moveSlideLeft()) : l.autoScrolling && n.abs(qe - Ie) > tt.height() / 100 * l.touchSensitivity && (qe > Ie ? ot("down", s) : Ie > qe && ot("up", s))
                        }
                    }
                }
                function lt(e, i) {
                ...
                function ht(t, e) {
                    for (var i = 0, r = t.slice(n.max(t.length - e, 1)), s = 0; s < r.length; s++)
                        i += r[s];
                    return n.ceil(i / e)
                }
                function ft(i) {
                    ...
                    if (l.autoScrolling && !ye) {
                        ...
                        Ae.length > 149 && Ae.shift(),
                        Ae.push(n.abs(s)),
                        l.scrollBar && (i.preventDefault ? i.preventDefault() : i.returnValue = !1);
                        var c = t(w)
                        ...
                        if ("undefined" != typeof r) {
                            ...
                            if (!(o.activeSection.is(e) && !Ce || l.scrollBar && tt.scrollTop() === o.dtop && !e.hasClass(P))) {
                                if (o.activeSlide.length)
                                    var a = o.activeSlide.data("anchor")
                                      , u = o.activeSlide.index();
                                if (l.autoScrolling && l.continuousVertical && "undefined" != typeof o.isMovementUp && (!o.isMovementUp && "up" == o.yMovement || o.isMovementUp && "down" == o.yMovement) && (o = vt(o)),
                                t.isFunction(l.onLeave) && !o.localIsResizing) {
                                    if (l.onLeave.call(o.activeSection, o.leavingSection, o.sectionIndex + 1, o.yMovement) === !1)
                                        return;
                                    Tt(o.activeSection)
                                }
                                e.addClass(_).siblings().removeClass(_),
                                bt(e),
                                Pe = !1,
                                Gt(u, a, o.anchorLink, o.sectionIndex),
                                gt(o),
                                _e = o.anchorLink,
                                jt(o.anchorLink, o.sectionIndex)
                            }
                        }
                    })
                }
                function gt(e) {
                    if (l.css3 && l.autoScrolling && !l.scrollBar) {
                        ...
                        Xt(i, !0),
                        l.scrollingSpeed ? De = setTimeout(function() {
                            xt(e)
                ...
                function vt(e) {
                    return e.isMovementUp ? t(w).before(e.activeSection.nextAll(b)) : t(w).after(e.activeSection.prevAll(b).get().reverse()),
                    ae(t(w).position().top),
                    dt(),
                    e.wrapAroundElements = e.activeSection,
                    e.dest = e.element.position(),
                    e.dtop = e.dest.top,
                    e.yMovement = qt(e.element),
                    e
                }
                function yt(e) {
                    e.wrapAroundElements && e.wrapAroundElements.length && (e.isMovementUp ? t(T).before(e.wrapAroundElements) : t(S).after(e.wrapAroundElements),
                    ae(t(w).position().top),
                    dt())
                }
                function xt(e) {
                    ...
                    t.isFunction(l.afterLoad) && !e.localIsResizing && l.afterLoad.call(e.element, e.anchorLink, e.sectionIndex + 1),
                    wt(e.element),
                    Pe = !0,
                ...
                function kt(e) {
                    ...
                    if (!i.is("textarea") && !i.is("input") && !i.is("select") && l.keyboardScrolling && l.autoScrolling) {
                        var n = e.which
                          , r = [40, 38, 32, 33, 34];
                        t.inArray(n, r) > -1 && e.preventDefault(),
                        ye = e.ctrlKey,
                ...
                function At(t) {
                    Pe && (t.pageY < Xe ? ge.moveSectionUp() : t.pageY > Xe && ge.moveSectionDown()),
                    Xe = t.pageY
                }
                function Ot(e, i) {
                    var r = i.position()
                    ...
                    if (l.onSlideLeave) {
                        var p = o.find(L)
                          , d = p.index()
                          , m = zt(d, s);
                        if (!f && "none" !== m && t.isFunction(l.onSlideLeave) && l.onSlideLeave.call(p, u, a + 1, d, m, s) === !1)
                            return void (xe = !1)
                    }
                    i.addClass(_).siblings().removeClass(_),
                    f || bt(i),
                    !l.loopHorizontal && l.controlArrows && (o.find(G).toggle(0 !== s),
                    o.find(J).toggle(!i.is(":last-child"))),
                    o.hasClass(_) && Gt(s, h, u, a);
                    var g = function() {
                        f || t.isFunction(l.afterSlideLoad) && l.afterSlideLoad.call(i, u, a + 1, h, s),
                        xe = !1
                    };
                    if (l.css3) {
                        var y = "translate3d(-" + n.round(r.left) + "px, 0px, 0px)";
                        Et(e.find(z), l.scrollingSpeed > 0).css(le(y)),
                    ...
                    c.find(v).removeClass(_),
                    c.find("li").eq(s).find("a").addClass(_)
                }
                function Rt() {
                    if (Dt(),
                    be) {
                        ...
                        if (!e.is("textarea") && !e.is("input") && !e.is("select")) {
                            var r = tt.height();
                            n.abs(r - We) > 20 * n.max(We, r) / 100 && (ge.reBuild(!0),
                            We = r)
                        }
                    } else
                        clearTimeout(Re),
                ...
                function Mt(t, e) {
                    ...
                    if (i > t || r > e) {
                        ...
                        me.css("font-size", "100%")
                }
                function Lt(e, i) {
                    l.navigation && (t(O).find(v).removeClass(_),
                    e ? t(O).find('a[href="#' + e + '"]').addClass(_) : t(O).find("li").eq(i).find("a").addClass(_))
                }
                function Ft(e) {
                    l.menu && (t(l.menu).find(v).removeClass(_),
                    t(l.menu).find('[data-menuanchor="' + e + '"]').addClass(_))
                }
                function jt(t, e) {
                    Ft(t),
                    Lt(t, e)
                ...
                function It(t) {
                    ...
                    var e, i = l.scrollOverflowHandler, n = i.wrapContent(), r = t.closest(b), s = i.scrollable(t);
                    s.length ? e = i.scrollHeight(t) : (e = t.get(0).scrollHeight,
                    l.verticalCentered && (e = t.find(k).get(0).scrollHeight));
                    var o = Se - parseInt(r.css("padding-bottom")) - parseInt(r.css("padding-top"));
                    e > o ? s.length ? i.update(t, o) : (l.verticalCentered ? t.find(k).wrapInner(n) : t.wrapInner(n),
                    i.create(t, o)) : i.remove(t),
                    t.css("overflow", "")
                }
                function Bt(t) {
                ...
                function Wt(e) {
                    ...
                    return i.length || (i = t(b).eq(e - 1)),
                    i
                }
                function Yt(t, e) {
                    var i = e.find(j)
                      , n = i.find(M + '[data-anchor="' + t + '"]');
                    return n.length || (n = i.find(M).eq(t)),
                    n
                }
                function $t(t, e) {
                    var i = Wt(t);
                    "undefined" == typeof e && (e = 0),
                    t === _e || i.hasClass(_) ? Ut(i, e) : mt(i, function() {
                        Ut(i, e)
                    })
                }
                function Ut(t, e) {
                ...
                function Vt(t, e) {
                    ...
                    i.find("li").first().find("a").addClass(_)
                }
                function Gt(t, e, i, n) {
                    var r = "";
                    l.anchors.length && !l.lockAnchors && (t ? ("undefined" != typeof i && (r = i),
                    "undefined" == typeof e && (e = t),
                    ve = e,
                    Qt(r + "/" + e)) : "undefined" != typeof t ? (ve = e,
                    Qt(i)) : Qt(i)),
                    Kt()
                }
                function Qt(t) {
                ...
                function Kt() {
                    ...
                    me[0].className = me[0].className.replace(o, ""),
                    me.addClass(g + "-" + s)
                }
                function Jt() {
                    var t, n = i.createElement("p"), s = {
                    ...
                    for (var o in s)
                        n.style[o] !== r && (n.style[o] = "translate3d(1px,1px,1px)",
                        t = e.getComputedStyle(n).getPropertyValue(s[o]));
                    return i.body.removeChild(n),
                    t !== r && t.length > 0 && "none" !== t
                }
                function te() {
                    i.addEventListener ? (i.removeEventListener("mousewheel", ft, !1),
                    i.removeEventListener("wheel", ft, !1),
                    i.removeEventListener("MozMousePixelScroll", ft, !1)) : i.detachEvent("onmousewheel", ft)
                }
                function ee() {
                    var t, n = "";
                ...
                function ie() {
                    if (be || we) {
                        var e = re();
                        t(a).off("touchstart " + e.down).on("touchstart " + e.down, ct),
                        t(a).off("touchmove " + e.move).on("touchmove " + e.move, at)
                    }
                }
                function ne() {
                    if (be || we) {
                        var e = re();
                        t(a).off("touchstart " + e.down),
                        t(a).off("touchmove " + e.move)
                    }
                }
                function re() {
                    var t;
                ...
                function se(t) {
                    ...
                    we && ut(t) && l.scrollBar && (e.y = t.touches[0].pageY,
                    e.x = t.touches[0].pageX),
                    e
                }
                function oe(t, e) {
                    ge.setScrollingSpeed(0, "internal"),
                    "undefined" != typeof e && (Ce = !0),
                    Ot(t.closest(j), t),
                    "undefined" != typeof e && (Ce = !1),
                ...
                function ce() {
                    ...
                    t("html").removeClass(m),
                    t.each(me.get(0).className.split(/\s+/), function(t, e) {
                        0 === e.indexOf(g) && me.removeClass(e)
                    }),
                    t(b + ", " + M).each(function() {
                        removeSlimScroll(t(this)),
                        t(this).removeClass(I + " " + _)
                    }),
                    Nt(Te),
                    Te.find(k + ", " + z + ", " + j).each(function() {
                ...
                function fe() {
                    l.continuousVertical && (l.loopTop || l.loopBottom) && (l.continuousVertical = !1,
                    pe("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
                    l.scrollBar && l.scrollOverflow && pe("warn", "Option `scrollBar` is mutually exclusive with `scrollOverflow`. Sections with scrollOverflow might not work well in Firefox"),
                    l.continuousVertical && l.scrollBar && (l.continuousVertical = !1,
                    pe("warn", "Option `scrollBar` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
                    t.each(l.anchors, function(e, i) {
                ...
                ge.setAutoScrolling = function(e, i) {
                    ...
                    ge.setRecordHistory(Fe.recordHistory, "internal"),
                    Te.css({
                    ...
                    ge.setRecordHistory(!1, "internal"),
                    Te.css({
                        "-ms-touch-action": "",
                        "touch-action": ""
                    }),
                    ae(0),
                    n.length && de.scrollTop(n.position().top))
                }
                ,
                ...
                ge.setAllowScrolling = function(e, i) {
                    "undefined" != typeof i ? (i = i.replace(/ /g, "").split(","),
                    t.each(i, function(t, i) {
                        ue(e, i, "m")
                    })) : e ? (ge.setMouseWheelScrolling(!0),
                    ie()) : (ge.setMouseWheelScrolling(!1),
                    ne())
                }
                ,
                ...
                ge.moveSectionUp = function() {
                    var e = t(w).prev(b);
                    e.length || !l.loopTop && !l.continuousVertical || (e = t(b).last()),
                    e.length && mt(e, null , !0)
                }
                ,
                ge.moveSectionDown = function() {
                    var e = t(w).next(b);
                    e.length || !l.loopBottom && !l.continuousVertical || (e = t(b).first()),
                    e.length && mt(e, null , !1)
                }
                ,
                ...
                ge.reBuild = function(e) {
                    if (!Te.hasClass(d)) {
                        ...
                        t(b).each(function() {
                            var e = t(this).find(j)
                              , i = t(this).find(M);
                            l.verticalCentered && t(this).find(k).css("height", Ht(t(this)) + "px"),
                            t(this).css("height", Se + "px"),
                            l.scrollOverflow && (i.length ? i.each(function() {
                                It(t(this))
                            }) : It(t(this))),
                            i.length > 1 && Ot(e, e.find(L))
                        });
                        var n = t(w)
                          , r = n.index(b);
                        r && ge.silentMoveTo(r + 1),
                        requestAnimFrame(function() {
                            Ce = !1
                        }),
                        t.isFunction(l.afterResize) && e && l.afterResize.call(Te),
                        t.isFunction(l.afterReBuild) && !e && l.afterReBuild.call(Te)
                    }
                }
                ,
                ge.setResponsive = function(e) {
                    var i = me.hasClass(f);
                    e ? i || (ge.setAutoScrolling(!1, "internal"),
                    ge.setFitToSection(!1, "internal"),
                    t(O).hide(),
                    me.addClass(f)) : i && (ge.setAutoScrolling(Fe.autoScrolling, "internal"),
                    ge.setFitToSection(Fe.autoScrolling, "internal"),
                    t(O).show(),
                    me.removeClass(f))
                }
                ;
                var _e, ve, ye, xe = !1, be = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), we = "ontouchstart"in e || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, Te = t(this), Se = tt.height(), Ce = !1, ke = !0, Pe = !0, Ae = [], Oe = {};
                Oe.m = {
                    up: !0,
                    down: !0,
                    left: !0,
                ...
                ge.destroy = function(e) {
                    ge.setAutoScrolling(!1, "internal"),
                    ge.setAllowScrolling(!1),
                    ge.setKeyboardScrolling(!1),
                    Te.addClass(d),
                    clearTimeout(Ee),
                    clearTimeout(De),
                    clearTimeout(Re),
                    clearTimeout(Ne),
                    clearTimeout(Me),
                    tt.off("scroll", st).off("hashchange", Ct).off("resize", Rt),
                    et.off("click", O + " a").off("mouseenter", O + " li").off("mouseleave", O + " li").off("click", X).off("mouseover", l.normalScrollElements).off("mouseout", l.normalScrollElements),
                    t(b).off("click", Y),
                    clearTimeout(Ee),
                    clearTimeout(De),
                    e && ce()
            ...
            var it = {
                ...
                remove: function(t) {
                    t.find(u).children().first().unwrap().unwrap(),
                    t.find(c).remove(),
                    t.find(h).remove()
                },
                update: function(t, e) {
            ...
            (i._gsQueue || (i._gsQueue = [])).push(function() {
                ...
                i._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
                    ...
                    c.render = function(t, e, i) {
                        ...
                        this._rawPrevTime = f = !e || t || v === t ? t : o)) : 1e-7 > t ? (this._totalTime = this._time = this._cycle = 0,
                        this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0,
                        (0 !== m || 0 === _ && v > 0) && (r = "onReverseComplete",
                        n = this._reversed),
                        0 > t && (this._active = !1,
                    ...
                    s.staggerTo = s.allTo = function(t, e, o, a, c, f, p) {
                        a = a || 0;
                        var d, m, g, _, v = o.delay || 0, y = [], x = function() {
                    ...
                    var d = function(t, i, n, r) {
                        ...
                        n = n !== !1,
                        r = r !== !1;
                        for (var s, o, a = p(r), l = i && n && r, u = a.length; --u > -1; )
                            o = a[u],
                ...
                i._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, n) {
                    var r = function(t) {
                        ...
                        for (n in r)
                            i = r[n],
                            u(i) && -1 !== i.join("").indexOf("{self}") && (r[n] = this._swapSelfInParams(i));
                    ...
                    _.render = function(t, e, i) {
                        ...
                        var n, r, o, a, l, u, f = this._dirty ? this.totalDuration() : this._totalDuration, p = this._time, d = this._startTime, m = this._timeScale, g = this._paused;
                        if (t >= f)
                            this._totalTime = this._time = f,
                            this._reversed || this._hasPausedChild() || (r = !0,
                            a = "onComplete",
                            l = !!this._timeline.autoRemoveChildren,
                            0 === this._duration && (0 === t || this._rawPrevTime < 0 || this._rawPrevTime === s) && this._rawPrevTime !== t && this._first && (l = !0,
                        ...
                        if (this._time !== p && this._first || i || l || u) {
                            ...
                            a && (this._gc || (d === this._startTime || m !== this._timeScale) && (0 === this._time || f >= this.totalDuration()) && (r && (c.length && h(),
                    ...
                    _.getChildren = function(t, e, i, r) {
                        ...
                        for (var s = [], o = this._first, a = 0; o; )
                            o._startTime < r || (o instanceof n ? e !== !1 && (s[a++] = o) : (i !== !1 && (s[a++] = o),
                    ...
                    _.getTweensOf = function(t, e) {
                        ...
                        i = n.getTweensOf(t),
                        r = i.length; --r > -1; )
                            (i[r].timeline === this || e && this._contains(i[r])) && (o[a++] = i[r]);
                ...
                i._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function(t, e, i) {
                    var n = function(e) {
                        t.call(this, e),
                        this._repeat = this.vars.repeat || 0,
                        this._repeatDelay = this.vars.repeatDelay || 0,
                    ...
                    u.render = function(t, e, i) {
                        ...
                        0 !== this._repeat && (h = d + this._repeatDelay,
                        ...
                        this._callback("onUpdate"))),
                        u && (this._locked || this._gc || (_ === this._startTime || v !== this._timeScale) && (0 === this._time || p >= this.totalDuration()) && (s && (o.length && a(),
                        this._timeline.autoRemoveChildren && this._enabled(!1, !1),
                        this._active = !1),
                ...
                function() {
                    var t = 180 / Math.PI
                      ...
                      , c = function(t, i, s, o, a) {
                        var l, c, h, f, p, d, m, g, _, v, y, x, b, w = t.length - 1, T = 0, S = t[0].a;
                        for (l = 0; w > l; l++)
                            p = t[T],
                            c = p.a,
                            h = p.d,
                            ...
                            a ? (y = e[l],
                            x = n[l],
                            b = (x + y) * i * .25 / (o ? .5 : r[l] || .5),
                            d = h - (h - c) * (o ? .5 * i : 0 !== y ? b / y : 0),
                            m = h + (f - h) * (o ? .5 * i : 0 !== x ? b / x : 0),
                            g = h - (d + ((m - d) * (3 * y / (y + x) + .5) / 4 || 0))) : (d = h - (h - c) * i * .5,
                            m = h + (f - h) * i * .5,
                            g = h - (d + m) / 2),
                            d += g,
                            m += g,
                            p.c = _ = d,
                            0 !== l ? p.b = S : p.b = S = p.a + .6 * (p.c - p.a),
                            p.da = h - c,
                            p.ca = _ - c,
                            p.ba = S - c,
                            s ? (v = u(c, S, _, h),
                      ...
                      , h = function(t, i, r, s) {
                        ...
                        if (o = t.length - 2,
                        0 > o)
                            return p[0] = new a(t[0][i],0,0,t[-1 > o ? 0 : 1][i]),
                            p;
                        for (l = 0; o > l; l++)
                            u = t[l][i],
                            c = t[l + 1][i],
                      ...
                      , f = function(t, i, o, a, u, f) {
                        var p, d, m, g, _, v, y, x, b = {}, w = [], T = f || t[0];
                      ...
                      , p = function(t, e, i) {
                        e = e || "soft";
                        var n, r, s, o, l, u, c, h, f, p, d, m = {}, g = "cubic" === e ? 3 : 2, _ = "soft" === e, v = [];
                        if (_ && i && (t = [i].concat(t)),
                        null == t || t.length < g + 1)
                        ...
                        for (u = v.length; --u > -1; ) {
                            ...
                            c = 0; h > c; c += g)
                                ...
                                s = l[c + 2],
                                o = 2 === g ? 0 : l[c + 3],
                                l[p++] = d = 3 === g ? new a(n,r,s,o) : new a(n,(2 * r + n) / 3,(2 * r + s) / 3,s);
                            l.length = p
                        }
                        return m
                    }
                      ...
                      , g = i._gsDefine.plugin({
                        ...
                        init: function(t, e, i) {
                            ...
                            var n, r, s, o, a, l = e.values || [], u = {}, c = l[0], h = e.autoRotate || i.vars.orientToBezier;
                        ...
                        set: function(e) {
                            ...
                            if (this._autoRotate) {
                                ...
                                for (r = T.length; --r > -1; )
                                    ...
                                    v += (x - v) * a,
                                    x += (g.c + (g.d - g.c) * a - x) * a,
                                    l = m ? Math.atan2(x - v, y - _) * w + b : this._initialRotations[r],
                                    p[s] ? d[s](l) : d[s] = l)
                            }
                        }
                    })
                ...
                i._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
                    ...
                    var h, f, p, d, m, g, _ = /(?:\d|\-\d|\.\d|\-\.\d)+/g, v = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, y = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, x = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, b = /(?:\d|\-|\+|=|#|\.)*/g, w = /opacity *= *([^)]*)/i, T = /opacity:([^;]*)/i, S = /alpha\(opacity *=.+?\)/i, C = /^(rgb|hsl)/, k = /([A-Z])/g, P = /-([a-z])/gi, A = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, O = function(t, e) {
                        return e.toUpperCase()
                    }, R = /(?:Left|Right|Width)/i, D = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, E = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, N = /,(?=[^\)]*(?:\(|$))/gi, M = Math.PI / 180, L = 180 / Math.PI, F = {}, j = document, q = function(t) {
                        return j.createElementNS ? j.createElementNS("http://www.w3.org/1999/xhtml", t) : j.createElement(t)
                    }, z = q("div"), I = q("img"), B = a._internals = {
                        _specialProps: u
                    }, H = navigator.userAgent, X = function() {
                        var t = H.indexOf("Android")
                          , e = q("a");
                        return p = -1 !== H.indexOf("Safari") && -1 === H.indexOf("Chrome") && (-1 === t || Number(H.substr(t + 8, 1)) > 3),
                        m = p && Number(H.substr(H.indexOf("Version/") + 8, 1)) < 6,
                        ...
                        n = 5; --n > -1 && void 0 === r[i[n] + t]; )
                            ;
                        return n >= 0 ? (U = 3 === n ? "ms" : i[n],
                        $ = "-" + U.toLowerCase() + "-",
                        U + t) : null
                    }, G = j.defaultView ? j.defaultView.getComputedStyle : function() {}
                    , Q = a.getStyle = function(t, e, i, n, r) {
                        var s;
                        return X || "opacity" !== e ? (!n && t.style[e] ? s = t.style[e] : (i = i || G(t)) ? s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(k, "-$1").toLowerCase()) : t.currentStyle && (s = t.currentStyle[e]),
                    ...
                    , Z = B.convertToPixels = function(t, i, n, r, s) {
                        ...
                        if ("auto" === r || !n)
                            return 0;
                        var o, l, u, c = R.test(i), h = t, f = z.style, p = 0 > n;
                        if (p && (n = -n),
                        "%" === r && -1 !== i.indexOf("border"))
                            o = n / 100 * (c ? t.clientWidth : t.clientHeight);
                        else {
                            if (f.cssText = "border:0 solid red;position:" + Q(t, "position") + ";line-height:0;",
                            ...
                            h.appendChild(z),
                            o = parseFloat(z[c ? "offsetWidth" : "offsetHeight"]),
                            h.removeChild(z),
                    ...
                    , J = function(t, e) {
                        ...
                        if (e = e || G(t, null ))
                            if (i = e.length)
                                for (; --i > -1; )
                                    r = e[i],
                                    (-1 === r.indexOf("-transform") || kt === r) && (s[r.replace(P, O)] = e.getPropertyValue(r));
                            else
                                for (i in e)
                                    (-1 === i.indexOf("Transform") || Ct === i) && (s[i] = e[i]);
                        else if (e = t.currentStyle || t.style)
                            for (i in e)
                                "string" == typeof i && void 0 === s[i] && (s[i.replace(P, O)] = e[i]);
                        return X || (s.opacity = W(t)),
                        n = qt(t, e, !1),
                        ...
                        for (o in i)
                            "cssText" !== o && "length" !== o && isNaN(o) && (e[o] !== (s = i[o]) || r && r[o]) && -1 === o.indexOf("Origin") && ("number" == typeof s || "string" == typeof s) && (l[o] = "auto" !== s || "left" !== o && "top" !== o ? "" !== s && "auto" !== s && "none" !== s || "string" != typeof e[o] || "" === e[o].replace(x, "") ? s : 0 : K(t, o),
                        ...
                        var n = parseFloat("width" === e ? t.offsetWidth : t.offsetHeight)
                          , r = et[e]
                          , s = r.length;
                        for (i = i || G(t, null ); --s > -1; )
                            n -= parseFloat(Q(t, "padding" + r[s], i, !0)) || 0,
                        ...
                        u === c ? o = a = 0 : (h = u - c,
                        a = l > .5 ? h / (2 - u - c) : h / (u + c),
                        o = u === n ? (r - s) / h + (s > r ? 6 : 0) : u === r ? (s - n) / h + 2 : (n - r) / h + 4,
                        o *= 60),
                        i[0] = o + .5 | 0,
                        i[1] = 100 * a + .5 | 0,
                        i[2] = 100 * l + .5 | 0),
                    ...
                    var pt = function(t, e, i, n) {
                        if (null == t)
                            ...
                            ;
                        var r, s = e ? (t.match(ft) || [""])[0] : "", o = t.split(s).join("").match(y) || [], a = t.substr(0, t.indexOf(o[0])), l = ")" === t.charAt(t.length - 1) ? ")" : "", u = -1 !== t.indexOf(" ") ? " " : ",", c = o.length, h = c > 0 ? o[0].replace(_, "") : "";
                    ...
                    B.CSSPropTween = function(t, e, i, r, s, a, l, u, c, h, f) {
                      ...
                      , vt = a.parseComplex = function(t, e, i, n, r, s, o, a, l, u) {
                        i = i || s || "",
                        o = new gt(t,e,0,0,o,u ? 2 : 1,null ,!1,a,i,n),
                        n += "";
                        var c, f, p, d, m, g, y, x, b, w, T, S, C, k = i.split(", ").join(",").split(" "), P = n.split(", ").join(",").split(" "), A = k.length, O = h !== !1;
                        for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (k = k.join(" ").replace(N, ", ").split(" "),
                        P = P.join(" ").replace(N, ", ").split(" "),
                        A = k.length),
                        A !== P.length && (k = (s || "").split(" "),
                        A = k.length),
                        o.plugin = l,
                        o.setRatio = u,
                        ft.lastIndex = 0,
                        c = 0; A > c; c++)
                            ...
                            x = parseFloat(d),
                            x || 0 === x)
                                o.appendXtra("", x, st(m, x), m.replace(v, ""), O && -1 !== m.indexOf("px"), !0);
                            else if (r && ft.test(d))
                                ...
                                b && !X && 0 === m[3] ? (o["xs" + o.l] += o.l ? " transparent" : "transparent",
                                o.e = o.e.split(P[c]).join("transparent")) : (X || (b = !1),
                                C ? o.appendXtra(b ? "hsla(" : "hsl(", d[0], st(m[0], d[0]), ",", !1, !0).appendXtra("", d[1], st(m[1], d[1]), "%,", !1).appendXtra("", d[2], st(m[2], d[2]), b ? "%," : "%" + S, !1) : o.appendXtra(b ? "rgba(" : "rgb(", d[0], m[0] - d[0], ",", !0, !0).appendXtra("", d[1], m[1] - d[1], ",", !0).appendXtra("", d[2], m[2] - d[2], b ? "," : S, !0),
                                b && (d = d.length < 4 ? 1 : d[3],
                                o.appendXtra("", d, (m.length < 4 ? 1 : m[3]) - d, S, !1))),
                                ft.lastIndex = 0;
                            else if (g = d.match(_)) {
                                if (y = m.match(v),
                                !y || y.length !== g.length)
                                ...
                                f = 0; f < g.length; f++)
                                    T = g[f],
                                    w = d.indexOf(T, p),
                                    o.appendXtra(d.substr(p, w - p), Number(T), st(y[f], T), "", O && "px" === d.substr(w + T.length, 2), 0 === f),
                                    p = w + T.length;
                                o["xs" + o.l] += d.substr(p)
                            } else
                                o["xs" + o.l] += o.l ? " " + d : d;
                        ...
                        if (!u[t]) {
                            ...
                            bt(t, {
                                parser: function(t, i, n, r, s, o, a) {
                                    ...
                                    u[n].parse(t, i, n, r, s, o, a)) : (Y("Error: " + e + " js file not loaded."),
                                    s)
                                }
                            })
                        }
                    ...
                    c.parseComplex = function(t, e, i, n, r, s) {
                        ...
                        l) {
                            ...
                            o = 0; u > o; o++)
                                ...
                                f && (c = e.indexOf(f),
                                h = i.indexOf(f),
                                c !== h && (-1 === h ? a[o] = a[o].split(f).join("") : -1 === c && (a[o] += " " + f)));
                            e = a.join(", "),
                            i = l.join(", ")
                        }
                    ...
                    var Tt, St = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), Ct = V("transform"), kt = $ + "transform", Pt = V("transformOrigin"), At = null !== V("perspective"), Ot = B.Transform = function() {
                        this.perspective = parseFloat(a.defaultTransformPerspective) || 0,
                        this.force3D = a.defaultForce3D !== !1 && At ? a.defaultForce3D || "auto" : !1
                    }
                    , Rt = window.SVGElement, Dt = function(t, e, i) {
                        ...
                        return j.createElementNS && !n && (t = Dt("svg", Et),
                        e = Dt("rect", t, {
                            width: 100,
                            height: 50,
                            x: 100
                        ...
                        n = i === e.getBoundingClientRect().width && !(d && At),
                        Et.removeChild(t)),
                        n
                    }(), Mt = function(t, e, i, n, r) {
                        var s, o, l, u, c, h, f, p, d, m, g, _, v, y, x = t._gsTransform, b = jt(t, !0);
                        x && (v = x.xOrigin,
                        y = x.yOrigin),
                        (!n || (s = n.split(" ")).length < 2) && (f = t.getBBox(),
                        e = rt(e).split(" "),
                        ...
                        g = b[5],
                        _ = h * d - f * p,
                        o = u * (d / _) + c * (-p / _) + (p * g - d * m) / _,
                        l = u * (-f / _) + c * (h / _) - (h * g - f * m) / _,
                        u = i.xOrigin = s[0] = o,
                        c = i.yOrigin = s[1] = l),
                        x && (r || r !== !1 && a.defaultSmoothOrigin !== !1 ? (o = u - v,
                        l = c - y,
                        x.xOffset += o * b[0] + l * b[2] - o,
                        x.yOffset += o * b[1] + l * b[3] - l) : x.xOffset = x.yOffset = 0),
                    ...
                    }, Ft = [1, 0, 0, 1, 0, 0], jt = function(t, e) {
                        var i, n, r, s, o, a = t._gsTransform || new Ot, l = 1e5;
                        if (Ct ? n = Q(t, kt, null , !0) : t.currentStyle && (n = t.currentStyle.filter.match(D),
                        n = n && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), a.x || 0, a.y || 0].join(",") : ""),
                        i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n,
                        (a.svg || t.getBBox && Lt(t)) && (i && -1 !== (t.style[Ct] + "").indexOf("matrix") && (n = t.style[Ct],
                        i = 0),
                        ...
                        yt = r.length; --yt > -1; )
                            s = Number(r[yt]),
                            r[yt] = (o = s - (s |= 0)) ? (o * l + (0 > o ? -.5 : .5) | 0) / l + s : s;
                        return e && r.length > 6 ? [r[0], r[1], r[4], r[5], r[12], r[13]] : r
                    }, qt = B.getTransform = function(t, i, n, r) {
                        if (t._gsTransform && n && !r)
                            return t._gsTransform;
                        var o, l, u, c, h, f, p = n ? t._gsTransform || new Ot : new Ot, d = p.scaleX < 0, m = 2e-5, g = 1e5, _ = At ? parseFloat(Q(t, Pt, i, !1, "0 0 0").split(" ")[2]) || p.zOrigin || 0 : 0, v = parseFloat(a.defaultTransformPerspective) || 0;
                        if (p.svg = !(!t.getBBox || !Lt(t)),
                        p.svg && (Mt(t, Q(t, Pt, s, !1, "50% 50%") + "", p, t.getAttribute("data-svg-origin")),
                        Tt = a.useSVGTransformAttr || Nt),
                        o = jt(t),
                        o !== Ft) {
                            if (16 === o.length) {
                                var y, x, b, w, T, S = o[0], C = o[1], k = o[2], P = o[3], A = o[4], O = o[5], R = o[6], D = o[7], E = o[8], N = o[9], M = o[10], F = o[12], j = o[13], q = o[14], z = o[11], I = Math.atan2(R, M);
                                p.zOrigin && (q = -p.zOrigin,
                                F = E * q - o[12],
                                j = N * q - o[13],
                                q = M * q + p.zOrigin - o[14]),
                                p.rotationX = I * L,
                                I && (w = Math.cos(-I),
                                T = Math.sin(-I),
                                y = A * w + E * T,
                                ...
                                p.rotationY += 180),
                                p.scaleX = (Math.sqrt(S * S + C * C) * g + .5 | 0) / g,
                                p.scaleY = (Math.sqrt(O * O + N * N) * g + .5 | 0) / g,
                                p.scaleZ = (Math.sqrt(R * R + M * M) * g + .5 | 0) / g,
                                p.skewX = 0,
                                p.perspective = z ? 1 / (0 > z ? -z : z) : 0,
                                p.x = F,
                                p.y = j,
                                p.z = q,
                                p.svg && (p.x -= p.xOrigin - (p.xOrigin * S - p.yOrigin * A),
                                p.y -= p.yOrigin - (p.yOrigin * C - p.xOrigin * O))
                                ...
                                u = Math.sqrt(H * H + X * X),
                                c = Math.sqrt(Y * Y + W * W),
                                h = H || X ? Math.atan2(X, H) * L : p.rotation || 0,
                                f = W || Y ? Math.atan2(W, Y) * L + h : p.skewX || 0,
                                Math.abs(f) > 90 && Math.abs(f) < 270 && (d ? (u *= -1,
                                f += 0 >= h ? 180 : -180,
                                h += 0 >= h ? 180 : -180) : (c *= -1,
                                f += 0 >= f ? 180 : -180)),
                                p.scaleX = u,
                                ...
                                p.perspective = v,
                                p.scaleZ = 1),
                                p.svg && (p.x -= p.xOrigin - (p.xOrigin * H + p.yOrigin * W),
                                p.y -= p.yOrigin - (p.xOrigin * X + p.yOrigin * Y))
                            }
                            p.zOrigin = _;
                            for (l in p)
                                p[l] < m && p[l] > -m && (p[l] = 0)
                        ...
                        p.svg && (Tt && t.style[Ct] ? e.delayedCall(.001, function() {
                            Ht(t.style, Ct)
                    ...
                    , zt = function(t) {
                        var e, i, n = this.data, r = -n.rotation * M, s = r + n.skewX * M, o = 1e5, a = (Math.cos(r) * n.scaleX * o | 0) / o, l = (Math.sin(r) * n.scaleX * o | 0) / o, u = (Math.sin(s) * -n.scaleY * o | 0) / o, c = (Math.cos(s) * n.scaleY * o | 0) / o, h = this.t.style, f = this.t.currentStyle;
                        if (f) {
                            i = l,
                            l = -u,
                            u = -i,
                            e = f.filter,
                            h.filter = "";
                            var p, d, m = this.t.offsetWidth, _ = this.t.offsetHeight, v = "absolute" !== f.position, y = "progid:DXImageTransform.Microsoft.Matrix(M11=" + a + ", M12=" + l + ", M21=" + u + ", M22=" + c, x = n.x + m * n.xPercent / 100, T = n.y + _ * n.yPercent / 100;
                            ...
                            v ? (p = m / 2,
                            d = _ / 2,
                            y += ", Dx=" + (p - (p * a + d * l) + x) + ", Dy=" + (d - (p * u + d * c) + T) + ")") : y += ", sizingMethod='auto expand')",
                            -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? h.filter = e.replace(E, y) : h.filter = y + " " + e,
                            (0 === t || 1 === t) && 1 === a && 0 === l && 0 === u && 1 === c && (v && -1 === y.indexOf("Dx=0, Dy=0") || w.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && h.removeAttribute("filter")),
                            !v) {
                                var S, C, k, P = 8 > g ? 1 : -1;
                                for (p = n.ieOffsetX || 0,
                                d = n.ieOffsetY || 0,
                                n.ieOffsetX = Math.round((m - ((0 > a ? -a : a) * m + (0 > l ? -l : l) * _)) / 2 + x),
                                n.ieOffsetY = Math.round((_ - ((0 > c ? -c : c) * _ + (0 > u ? -u : u) * m)) / 2 + T),
                                yt = 0; 4 > yt; yt++)
                                    C = it[yt],
                                    S = f[C],
                                    i = -1 !== S.indexOf("px") ? parseFloat(S) : Z(this.t, C, parseFloat(S), S.replace(b, "")) || 0,
                                    k = i !== n[C] ? 2 > yt ? -n.ieOffsetX : -n.ieOffsetY : 2 > yt ? p - n.ieOffsetX : d - n.ieOffsetY,
                                    h[C] = (n[C] = Math.round(i - k * (0 === yt || 2 === yt ? 1 : P))) + "px"
                            }
                        }
                    }, It = B.set3DTransformRatio = B.setTransformRatio = function(t) {
                        var e, i, n, r, s, o, a, l, u, c, h, f, p, m, g, _, v, y, x, b, w, T, S, C = this.data, k = this.t.style, P = C.rotation, A = C.rotationX, O = C.rotationY, R = C.scaleX, D = C.scaleY, E = C.scaleZ, N = C.x, L = C.y, F = C.z, j = C.svg, q = C.perspective, z = C.force3D;
                        if (((1 === t || 0 === t) && "auto" === z && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime) || !z) && !F && !q && !O && !A || Tt && j || !At)
                            return void (P || C.skewX || j ? (P *= M,
                            T = C.skewX * M,
                            S = 1e5,
                            e = Math.cos(P) * R,
                            r = Math.sin(P) * R,
                            i = Math.sin(P - T) * -D,
                            s = Math.cos(P - T) * D,
                            T && "simple" === C.skewType && (v = Math.tan(T),
                            v = Math.sqrt(1 + v * v),
                            i *= v,
                            s *= v,
                            C.skewY && (e *= v,
                            r *= v)),
                            j && (N += C.xOrigin - (C.xOrigin * e + C.yOrigin * i) + C.xOffset,
                            L += C.yOrigin - (C.xOrigin * r + C.yOrigin * s) + C.yOffset,
                            Tt && (C.xPercent || C.yPercent) && (m = this.t.getBBox(),
                            N += .01 * C.xPercent * m.width,
                            L += .01 * C.yPercent * m.height),
                            m = 1e-6,
                            m > N && N > -m && (N = 0),
                            m > L && L > -m && (L = 0)),
                            x = (e * S | 0) / S + "," + (r * S | 0) / S + "," + (i * S | 0) / S + "," + (s * S | 0) / S + "," + N + "," + L + ")",
                            j && Tt ? this.t.setAttribute("transform", "matrix(" + x) : k[Ct] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix(" : "matrix(") + x) : k[Ct] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix(" : "matrix(") + R + ",0,0," + D + "," + N + "," + L + ")");
                        if (d && (m = 1e-4,
                        m > R && R > -m && (R = E = 2e-5),
                        m > D && D > -m && (D = E = 2e-5),
                        !q || C.z || C.rotationX || C.rotationY || (q = 0)),
                        P || C.skewX)
                            P *= M,
                            g = e = Math.cos(P),
                            _ = r = Math.sin(P),
                            ...
                            g = Math.cos(P),
                            _ = Math.sin(P),
                            "simple" === C.skewType && (v = Math.tan(C.skewX * M),
                            v = Math.sqrt(1 + v * v),
                            g *= v,
                            _ *= v,
                            C.skewY && (e *= v,
                            ...
                            if (!(O || A || 1 !== E || q || j))
                                return void (k[Ct] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) translate3d(" : "translate3d(") + N + "px," + L + "px," + F + "px)" + (1 !== R || 1 !== D ? " scale(" + R + "," + D + ")" : ""));
                            e = s = 1,
                            i = r = 0
                        }
                        u = 1,
                        ...
                        x += (m > e && e > -m ? w : e) + b + (m > r && r > -m ? w : r) + b + (m > a && a > -m ? w : a),
                        x += b + (m > c && c > -m ? w : c) + b + (m > i && i > -m ? w : i) + b + (m > s && s > -m ? w : s),
                        A || O ? (x += b + (m > l && l > -m ? w : l) + b + (m > h && h > -m ? w : h) + b + (m > n && n > -m ? w : n),
                        x += b + (m > o && o > -m ? w : o) + b + (m > u && u > -m ? w : u) + b + (m > f && f > -m ? w : f) + b) : x += ",0,0,0,0,1,0,",
                        x += N + b + L + b + F + b + (q ? 1 + -F / q : 1) + ")",
                        k[Ct] = x
                    }
                    ;
                    c = Ot.prototype,
                    ...
                    bt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                        parser: function(t, e, i, n, r, o, l) {
                            ...
                            var u, c, h, f, p, d, m, g, _, v, y = t._gsTransform, x = t.style, b = 1e-6, w = St.length, T = l, S = {}, C = "transformOrigin";
                            if (l.display ? (f = Q(t, "display"),
                            x.display = "block",
                            u = qt(t, s, !0, l.parseTransform),
                            x.display = f) : u = qt(t, s, !0, l.parseTransform),
                            n._transform = u,
                            "string" == typeof T.transform && Ct)
                                ...
                                null != T.xPercent && (c.xPercent = ot(T.xPercent, u.xPercent)),
                                null != T.yPercent && (c.yPercent = ot(T.yPercent, u.yPercent));
                                ...
                                c.xPercent = ot(T.x, u.xPercent)),
                                "string" == typeof T.y && -1 !== T.y.indexOf("%") && (c.y = 0,
                                c.yPercent = ot(T.y, u.yPercent)),
                                c.rotation = at("rotation"in T ? T.rotation : "shortRotation"in T ? T.shortRotation + "_short" : "rotationZ"in T ? T.rotationZ : u.rotation, u.rotation, "rotation", S),
                                At && (c.rotationX = at("rotationX"in T ? T.rotationX : "shortRotationX"in T ? T.shortRotationX + "_short" : u.rotationX || 0, u.rotationX, "rotationX", S),
                                c.rotationY = at("rotationY"in T ? T.rotationY : "shortRotationY"in T ? T.shortRotationY + "_short" : u.rotationY || 0, u.rotationY, "rotationY", S)),
                            ...
                            d = u.force3D || u.z || u.rotationX || u.rotationY || c.z || c.rotationX || c.rotationY || c.perspective,
                            d || null == T.scale || (c.scaleZ = 1); --w > -1; )
                                i = St[w],
                                p = c[i] - u[i],
                                (p > b || -b > p || null != T[i] || null != F[i]) && (m = !0,
                                r = new gt(u,i,u[i],p,r),
                                i in S && (r.e = S[i]),
                                r.xs0 = 0,
                                r.plugin = o,
                                n._overwriteProps.push(r.n));
                            return p = T.transformOrigin,
                            u.svg && (p || T.svgOrigin) && (_ = u.xOffset,
                            v = u.yOffset,
                            Mt(t, rt(p), c, T.svgOrigin, T.smoothOrigin),
                            r = _t(u, "xOrigin", (y ? u : c).xOrigin, c.xOrigin, r, C),
                            r = _t(u, "yOrigin", (y ? u : c).yOrigin, c.yOrigin, r, C),
                            (_ !== u.xOffset || v !== u.yOffset) && (r = _t(u, "xOffset", y ? _ : u.xOffset, u.xOffset, r, C),
                            r = _t(u, "yOffset", y ? v : u.yOffset, u.yOffset, r, C)),
                            p = Tt ? null : "0px 0px"),
                            (p || At && d && u.zOrigin) && (Ct ? (m = !0,
                            i = Pt,
                            p = (p || Q(t, i, s, !1, "50% 50%")) + "",
                            r = new gt(x,i,0,0,r,-1,C),
                            r.b = x[i],
                            r.plugin = o,
                            At ? (f = u.zOrigin,
                            p = p.split(" "),
                            u.zOrigin = (p.length > 2 && (0 === f || "0px" !== p[2]) ? parseFloat(p[2]) : f) || 0,
                            r.xs0 = r.e = p[0] + " " + (p[1] || "50%") + " 0px",
                            r = new gt(u,"zOrigin",0,0,r,-1,r.n),
                            r.b = f,
                            r.xs0 = r.e = u.zOrigin) : r.xs0 = r.e = p) : rt(p + "", u)),
                            m && (n._transformType = u.svg && Tt || !d && 3 !== this._transformType ? 2 : 3),
                            r
                        },
                        prefix: !0
                    }),
                    ...
                    bt("borderRadius", {
                        ...
                        parser: function(t, e, i, n, o, a) {
                            e = this.format(e);
                            var l, u, c, h, f, p, d, m, g, _, v, y, x, b, w, T, S = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], C = t.style;
                            for (g = parseFloat(t.offsetWidth),
                            _ = parseFloat(t.offsetHeight),
                            l = e.split(" "),
                            u = 0; u < S.length; u++)
                                this.p.indexOf("border") && (S[u] = V(S[u])),
                                f = h = Q(t, S[u], s, !1, "0px"),
                                ...
                                v = p.substr((m + "").length)),
                                "" === v && (v = r[i] || y),
                                v !== y && (b = Z(t, "borderLeft", d, y),
                                w = Z(t, "borderTop", d, y),
                                "%" === v ? (f = b / g * 100 + "%",
                                h = w / _ * 100 + "%") : "em" === v ? (T = Z(t, "borderLeft", 1, "em"),
                                f = b / T + "em",
                                h = w / T + "em") : (f = b + "px",
                                h = w + "px"),
                                x && (p = parseFloat(f) + m + v,
                                c = parseFloat(h) + m + v)),
                                o = vt(C, S[u], f + " " + h, p + " " + c, !1, "0px", o);
                            return o
                        },
                        prefix: !0,
                    ...
                    bt("backgroundPosition", {
                        ...
                        parser: function(t, e, i, n, r, o) {
                            var a, l, u, c, h, f, p = "background-position", d = s || G(t, null ), m = this.format((d ? g ? d.getPropertyValue(p + "-x") + " " + d.getPropertyValue(p + "-y") : d.getPropertyValue(p) : t.currentStyle.backgroundPositionX + " " + t.currentStyle.backgroundPositionY) || "0 0"), _ = this.format(e);
                            if (-1 !== m.indexOf("%") != (-1 !== _.indexOf("%")) && (f = Q(t, "backgroundImage").replace(A, ""),
                            f && "none" !== f)) {
                                for (a = m.split(" "),
                                l = _.split(" "),
                                ...
                                u = 2; --u > -1; )
                                    m = a[u],
                                    c = -1 !== m.indexOf("%"),
                                    c !== (-1 !== l[u].indexOf("%")) && (h = 0 === u ? t.offsetWidth - I.width : t.offsetHeight - I.height,
                    ...
                    bt("clip", {
                        ...
                        parser: function(t, e, i, n, r, o) {
                            ...
                            e = this.format(e).split(",").join(u)) : (a = this.format(Q(t, this.p, s, !1, this.dflt)),
                            e = this.format(e)),
                    ...
                    var Bt = function(t) {
                        var e, i = this.t, n = i.filter || Q(this.data, "filter") || "", r = this.s + this.c * t | 0;
                        100 === r && (-1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (i.removeAttribute("filter"),
                        e = !Q(this.data, "filter")) : (i.filter = n.replace(S, ""),
                        e = !0)),
                    ...
                    bt("opacity,alpha,autoAlpha", {
                        ...
                        parser: function(t, e, i, n, r, o) {
                            ...
                            u && 1 === a && "hidden" === Q(t, "visibility", s) && 0 !== e && (a = 0),
                            X ? r = new gt(l,"opacity",a,e - a,r) : (r = new gt(l,"opacity",100 * a,100 * (e - a),r),
                            r.xn1 = u ? 1 : 0,
                            l.zoom = 1,
                            r.type = 2,
                            ...
                            r.plugin = o,
                            r.setRatio = Bt),
                            u && (r = new gt(l,"visibility",0,0,r,-1,null ,!1,0,0 !== a ? "inherit" : "hidden",0 === e ? "hidden" : "inherit"),
                            r.xs0 = "inherit",
                            n._overwriteProps.push(r.n),
                    ...
                    bt("className", {
                        parser: function(t, e, i, r, o, a, l) {
                            ...
                            if (o = r._classNamePT = new gt(t,i,0,0,o,2),
                            o.setRatio = Xt,
                            o.pr = -11,
                            n = !0,
                            o.b = d,
                            ...
                            o.e = "=" !== e.charAt(1) ? e : d.replace(new RegExp("\\s*\\b" + e.substr(2) + "\\b"), "") + ("+" === e.charAt(0) ? " " + e.substr(2) : ""),
                    ...
                    var Wt = function(t) {
                        if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                            ...
                            if ("all" === this.e)
                                ...
                                n = e.length; --n > -1; )
                                    i = e[n],
                                    u[i] && (u[i].parse === a ? r = !0 : i = "transformOrigin" === i ? Pt : u[i].p),
                                    Ht(o, i);
                            r && (Ht(o, Ct),
                    ...
                    c._onInitTween = function(t, e, i) {
                        ...
                        if (f && "" === w.zIndex && (l = Q(t, "zIndex", s),
                        ("auto" === l || "" === l) && this._addLazySet(w, "zIndex", 0)),
                        "string" == typeof e && (g = w.cssText,
                        l = J(t, s),
                        w.cssText = g + ";" + e,
                        l = tt(t, l, J(t)).difs,
                        !X && T.test(e) && (l.opacity = parseFloat(RegExp.$1)),
                        e = l,
                        w.cssText = g),
                        e.className ? this._firstPT = c = u.className.parse(t, e.className, "className", this, null , null , e) : this._firstPT = c = this.parse(t, e, null ),
                        this._transformType) {
                            for (b = 3 === this._transformType,
                            Ct ? p && (f = !0,
                            "" === w.zIndex && (y = Q(t, "zIndex", s),
                            ...
                            x.setRatio = Ct ? It : zt,
                            x.data = this._transform || qt(t, s, !0),
                            x.tween = i,
                            x.pr = -1,
                            o.pop()
                        }
                        if (n) {
                            for (; c; ) {
                                ...
                                d = g; d && d.pr > c.pr; )
                                    d = d._next;
                                (c._prev = d ? d._prev : _) ? c._prev._next = c : g = c,
                    ...
                    c.parse = function(t, e, i, n) {
                        ...
                        for (o in e)
                            p = e[o],
                            a = u[o],
                            a ? i = a.parse(t, p, o, this, i, n, e) : (f = Q(t, o, s) + "",
                            g = "string" == typeof p,
                            "color" === o || "fill" === o || "stroke" === o || -1 !== o.indexOf("Color") || g && C.test(p) ? (g || (p = ct(p),
                            p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")"),
                            i = vt(v, o, f, p, !0, "transparent", i, 0, n)) : !g || -1 === p.indexOf(" ") && -1 === p.indexOf(",") ? (l = parseFloat(f),
                            d = l || 0 === l ? f.substr((l + "").length) : "",
                            ("" === f || "auto" === f) && ("width" === o || "height" === o ? (l = nt(t, o, s),
                            d = "px") : "left" === o || "top" === o ? (l = K(t, o, s),
                            ...
                            m = g ? p.replace(b, "") : ""),
                            "" === m && (m = o in r ? r[o] : d),
                            p = c || 0 === c ? (_ ? c + l : c) + m : e[o],
                            d !== m && "" !== m && (c || 0 === c) && l && (l = Z(t, o, l, d),
                            "%" === m ? (l /= Z(t, o, 100, "%") / 100,
                            e.strictUnits !== !0 && (f = l + "%")) : "em" === m || "rem" === m ? l /= Z(t, o, 1, m) : "px" !== m && (c = Z(t, o, c, m),
                            m = "px"),
                            _ && (c || 0 === c) && (p = c + l + m)),
                            _ && (c += l),
                            !l && 0 !== l || !c && 0 !== c ? void 0 !== v[o] && (p || p + "" != "NaN" && null != p) ? (i = new gt(v,o,c || l || 0,0,i,-1,o,!1,0,f,p),
                            i.xs0 = "none" !== p || "display" !== o && -1 === o.indexOf("Style") ? p : f) : Y("invalid " + o + " tween value: " + e[o]) : (i = new gt(v,o,l,c - l,i,0,o,h !== !1 && ("px" === m || "zIndex" === o),0,f,p),
                            i.xs0 = m)) : i = vt(v, o, f, p, !0, null , i, 0, n)),
                ...
                i._gsDefine.plugin({
                    ...
                    init: function(t, e, i) {
                        ...
                        for (n in e)
                            "useRadians" !== n && (l = (e[n] + "").split("_"),
                            r = l[0],
                            s = parseFloat("function" != typeof t[n] ? t[n] : t[n.indexOf("set") || "function" != typeof t["get" + n.substr(3)] ? n : "get" + n.substr(3)]()),
                            o = this.finals[n] = "string" == typeof r && "=" === r.charAt(1) ? s + parseInt(r.charAt(0) + "1", 10) * Number(r.substr(2)) : Number(r) || 0,
                            a = o - s,
                            l.length && (r = l.join("_"),
                            -1 !== r.indexOf("short") && (a %= u,
                            a !== a % (u / 2) && (a = 0 > a ? a + u : a - u)),
                            -1 !== r.indexOf("_cw") && 0 > a ? a = (a + 9999999999 * u) % u - (a / u | 0) * u : -1 !== r.indexOf("ccw") && a > 0 && (a = (a - 9999999999 * u) % u - (a / u | 0) * u)),
                            (a > c || -c > a) && (this._addTween(t, n, s, s + a, n),
                            this._overwriteProps.push(n)));
                        return !0
                    },
                    set: function(t) {
                ...
                i._gsDefine("easing.Back", ["easing.Ease"], function(t) {
                    var e, n, r, s = i.GreenSockGlobals || i, o = s.com.greensock, a = 2 * Math.PI, l = Math.PI / 2, u = o._class, c = function(e, i) {
                    ...
                    n = u("easing.RoughEase", function(e) {
                        e = e || {};
                        for (var i, n, r, s, o, a, l = e.taper || "none", u = [], c = 0, h = 0 | (e.points || 20), f = h, d = e.randomize !== !1, m = e.clamp === !0, g = e.template instanceof t ? e.template : null , _ = "number" == typeof e.strength ? .4 * e.strength : .4; --f > -1; )
                ...
                if (!n.TweenLite) {
                    var r, s, o, a, l, u = function(t) {
                        ...
                        this.check = function(c) {
                            for (var h, f, p, d, _, v = s.length, y = v; --v > -1; )
                                (h = m[s[v]] || new g(s[v],[])).gsClass ? (l[v] = h.gsClass,
                                y--) : c && h.sc.push(this);
                            if (0 === y && o)
                                for (f = ("com.greensock." + r).split("."),
                                p = f.pop(),
                                d = u(f.join("."))[p] = this.gsClass = o.apply(o, l),
                                a && (n[p] = d,
                                _ = "undefined" != typeof e && e.exports,
                                !_ && "function" == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + r.split(".").pop(), [], function() {
                                    return d
                                }) : r === i && _ && (e.exports = d)),
                    ...
                    o.addEventListener = function(t, e, i, n, r) {
                        ...
                        o = u.length; --o > -1; )
                            s = u[o],
                            s.c === e && s.s === i ? u.splice(o, 1) : 0 === c && s.pr < r && (c = o + 1);
                        u.splice(c, 0, {
                            c: e,
                            s: i,
                            up: n,
                    ...
                    s = r.length; --s > -1 && !C; )
                        C = t[r[s] + "RequestAnimationFrame"],
                        k = t[r[s] + "CancelAnimationFrame"] || t[r[s] + "CancelRequestAnimationFrame"];
                    v("Ticker", function(t, e) {
                        var i, n, r, s, o, u = this, c = P(), f = e !== !1 && C, d = 500, m = 33, g = "tick", _ = function(t) {
                            var e, a, l = P() - A;
                            l > d && (c += l - m),
                            A += l,
                            u.time = (A - c) / 1e3,
                        ...
                        ,
                        u.wake = function() {
                            null !== r ? u.sleep() : u.frame > 10 && (A = P() - d + 5),
                            n = 0 === i ? p : f && C ? C : function(t) {
                    ...
                    var E = v("TweenLite", function(e, i, n) {
                        ...
                        if (this._overwrite = l = null == l ? $[E.defaultOverwrite] : "number" == typeof l ? l >> 0 : $[l],
                        (a || e instanceof Array || e.push && d(e)) && "number" != typeof e[0])
                            ...
                            r = 0; r < o.length; r++)
                                ...
                                this._targets = o = o.concat(f(s))) : (this._siblings[r] = Z(s, this, !1),
                      ...
                      , M = function(t, e) {
                        var i, n = {};
                        for (i in t)
                            Y[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!H[i] || H[i] && H[i]._autoCSS) || (n[i] = t[i],
                            delete t[i]);
                        t.css = n
                    };
                    o = E.prototype = new O,
                    ...
                    var L = []
                      ...
                      , z = function(t, e, i, n) {
                        var r, s, o, a, l, u, c, h = [t, e], f = 0, p = "", d = 0;
                        for (h.start = t,
                        i && (i(h),
                        t = h[0],
                        e = h[1]),
                      ...
                      , I = function(t, e, i, n, r, s, o, a) {
                        var l, u, c = "get" === i ? t[e] : i, h = typeof t[e], f = "string" == typeof n && "=" === n.charAt(1), p = {
                            t: t,
                            p: e,
                            s: c,
                            f: "function" === h,
                        ...
                        return "number" !== h && ("function" === h && "get" === i && (u = e.indexOf("set") || "function" != typeof t["get" + e.substr(3)] ? e : "get" + e.substr(3),
                        p.s = c = o ? t[u](o) : t[u]()),
                        "string" == typeof c && (o || isNaN(c)) ? (p.fp = o,
                        l = z(c, n, a || E.defaultStringFilter, p),
                        p = {
                            t: l,
                            p: "setRatio",
                            s: 0,
                            ...
                            n: r || e,
                            pr: 0
                        }) : f || (p.c = parseFloat(n) - parseFloat(c) || 0)),
                    ...
                    O._updateRoot = E.render = function() {
                        ...
                        a.frame >= G) {
                            ...
                            if (i = V._first,
                            (!i || i._paused) && E.autoSleep && !U._first && 1 === a._listeners.tick.length) {
                                for (; i && i._paused; )
                                    i = i._next;
                                i || a.sleep()
                            }
                    ...
                    var Z = function(t, e, i) {
                      ...
                      , J = function(t, e, i, n, r) {
                        ...
                        for (s = r.length; --s > -1; )
                            ...
                            0 === tt(a, u, d) && (f[p++] = a)) : a._startTime <= c && a._startTime + a.totalDuration() / a._timeScale > c && ((d || !a._initted) && c - a._startTime <= 2e-10 || (f[p++] = a)));
                        for (s = p; --s > -1; )
                            if (a = f[s],
                    ...
                    o._init = function() {
                        ...
                        if (this._ease = u = u ? u instanceof b ? u : "function" == typeof u ? new b(u,s.easeParams) : w[u] || E.defaultEase : E.defaultEase,
                    ...
                    o._initProps = function(e, i, n, r) {
                        ...
                        if (null == e)
                            return !1;
                        F[e._gsTweenID] && Q(),
                        this.vars.css || e.style && e !== t && e.nodeType && H.css && this.vars.autoCSS !== !1 && M(this.vars, e);
                        for (s in this.vars)
                            if (c = this.vars[s],
                            Y[s])
                                c && (c instanceof Array || c.push && d(c)) && -1 !== c.join("").indexOf("{self}") && (this.vars[s] = c = this._swapSelfInParams(c, this));
                                ...
                                i[s] = I.call(this, e, s, "get", c, s, 0, null , this.vars.stringFilter);
                        ...
                        this._initProps(e, i, n, r)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (F[e._gsTweenID] = !0),
                        a)
                    }
                    ,
                    o.render = function(t, e, i) {
                    ...
                    et.activate = function(t) {
                        for (var e = t.length; --e > -1; )
                            t[e].API === et.API && (H[(new t[e])._propName] = t[e]);
                        return !0
                    }
                    ,
                    _.plugin = function(t) {
        ...
        !function(t, i) {
            ...
            function x(t) {
                var e = Z
                  , i = It[t];
                return i || (i = y(t, e),
                "none" !== i && i || (zt = (zt || J("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement),
            ...
            function P(t, e) {
                for (var i, n, r, s = [], o = 0, a = t.length; a > o; o++)
                    ...
                    "" === n.style.display && Tt(n) && (s[o] = _t.access(n, "olddisplay", x(n.nodeName)))) : (r = Tt(n),
            ...
            function E(t, e, i) {
                var n, r, s, o, a, l, u, c, h = this, f = {}, p = t.style, d = t.nodeType && Tt(t), m = _t.get(t, "fxshow");
                ...
                u = J.css(t, "display"),
                c = "none" === u ? _t.get(t, "olddisplay") || x(t.nodeName) : u,
                "inline" === c && "none" === J.css(t, "float") && (p.display = "inline-block")),
            ...
            function M(t, e, i) {
                var n, r, s = 0, o = ee.length, a = J.Deferred().always(function() {
                    ...
                    if (r)
                        return !1;
                    for (var e = Qt || O(), i = Math.max(0, u.startTime + u.duration - e), n = i / u.duration || 0, s = 1 - n, o = 0, l = u.tweens.length; l > o; o++)
                        u.tweens[o].run(s);
            ...
            J.extend({
                ...
                makeArray: function(t, e) {
                    var n = e || [];
                    return null != t && (i(Object(t)) ? J.merge(n, "string" == typeof t ? [t] : t) : Y.call(n, t)),
                    n
                },
                ...
                proxy: function(t, e) {
                    ...
                    e = t,
                    t = i),
                    J.isFunction(t) ? (n = X.call(arguments, 2),
                    r = function() {
            ...
            var rt = function(t) {
                function e(t, e, i, n) {
                    ...
                    if ((e ? e.ownerDocument || e : I) !== E && D(e),
                    e = e || E,
                    i = i || [],
                    a = e.nodeType,
                    ...
                    if (!n && M) {
                            ...
                            if (o = r[1]) {
                                if (9 === a) {
                                    ...
                                    if (s.id === o)
                                        return i.push(s),
                                        i
                                } else if (e.ownerDocument && (s = e.ownerDocument.getElementById(o)) && q(e, s) && s.id === o)
                                    return i.push(s),
                                    i
                            } else {
                                if (r[2])
                                    ...
                                    i;
                                if ((o = r[3]) && b.getElementsByClassName)
                        ...
                        if (b.qsa && (!L || !L.test(t))) {
                            ...
                            1 === a && "object" !== e.nodeName.toLowerCase()) {
                                for (u = C(t),
                                (h = e.getAttribute("id")) ? p = h.replace(xt, "\\$&") : e.setAttribute("id", p),
                                p = "[id='" + p + "'] ",
                                l = u.length; l--; )
                                    u[l] = p + f(u[l]);
                                d = yt.test(t) && c(e.parentNode) || e,
                                m = u.join(",")
                            }
                            if (m)
                                try {
                                    return K.apply(i, d.querySelectorAll(m)),
                                    i
                                } catch (g) {} finally {
                ...
                function _(t, e, i, r, s, o) {
                    ...
                    s && !s[z] && (s = _(s, o)),
                    n(function(n, o, a, l) {
                        var u, c, h, f = [], p = [], d = o.length, _ = n || m(e || "*", a.nodeType ? [a] : a, []), v = !t || !n && e ? _ : g(_, f, t, a, l), y = i ? s || (n ? t : d || r) ? [] : o : v;
                        if (i && i(v, y, a, l),
                        r)
                            for (u = g(y, p),
                            r(u, [], a, l),
                ...
                function y(t, i) {
                    var r = i.length > 0
                      ...
                      , o = function(n, o, a, l, u) {
                        var c, h, f, p = 0, d = "0", m = n && [], _ = [], v = A, y = n || s && w.find.TAG("*", u), x = B += null == v ? 1 : Math.random() || .1, b = y.length;
                ...
                var x, b, w, T, S, C, k, P, A, O, R, D, E, N, M, L, F, j, q, z = "sizzle" + 1 * new Date, I = t.document, B = 0, H = 0, X = i(), W = i(), Y = i(), $ = function(t, e) {
                    return t === e && (R = !0),
                    0
                }, U = 1 << 31, V = {}.hasOwnProperty, G = [], Q = G.pop, Z = G.push, K = G.push, J = G.slice, tt = function(t, e) {
                    for (var i = 0, n = t.length; n > i; i++)
                        if (t[i] === e)
                            return i;
                    return -1
                }, et = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", it = "[\\x20\\t\\r\\n\\f]", nt = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", rt = nt.replace("w", "w#"), st = "\\[" + it + "*(" + nt + ")(?:" + it + "*([*^$|!~]?=)" + it + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + rt + "))|)" + it + "*\\]", ot = ":(" + nt + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + st + ")*)|.*)\\)|)", at = new RegExp(it + "+","g"), lt = new RegExp("^" + it + "+|((?:^|[^\\\\])(?:\\\\.)*)" + it + "+$","g"), ut = new RegExp("^" + it + "*," + it + "*"), ct = new RegExp("^" + it + "*([>+~]|" + it + ")" + it + "*"), ht = new RegExp("=" + it + "*([^\\]'\"]*?)" + it + "*\\]","g"), ft = new RegExp(ot), pt = new RegExp("^" + rt + "$"), dt = {
                    ID: new RegExp("^#(" + nt + ")"),
                    CLASS: new RegExp("^\\.(" + nt + ")"),
                ...
                }, mt = /^(?:input|select|textarea|button)$/i, gt = /^h\d$/i, _t = /^[^{]+\{\s*\[native \w/, vt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, yt = /[+~]/, xt = /'|\\/g, bt = new RegExp("\\\\([\\da-f]{1,6}" + it + "?|(" + it + ")|.)","ig"), wt = function(t, e, i) {
                    var n = "0x" + e - 65536;
                ...
                try {
                    K.apply(G = J.call(I.childNodes), I.childNodes),
                ...
                D = e.setDocument = function(t) {
                    ...
                    b.getElementsByClassName = _t.test(n.getElementsByClassName),
                    b.getById = r(function(t) {
                        return N.appendChild(t).id = z,
                    ...
                    F = [],
                    L = [],
                    (b.qsa = _t.test(n.querySelectorAll)) && (r(function(t) {
                        N.appendChild(t).innerHTML = "<a id='" + z + "'></a><select id='" + z + "-\f]' msallowcapture=''><option selected=''></option></select>",
                    ...
                    q = e || _t.test(N.contains) ? function(t, e) {
                    ...
                    $ = e ? function(t, e) {
                        ...
                        1 & i || !b.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === I && q(I, t) ? -1 : e === n || e.ownerDocument === I && q(I, e) ? 1 : O ? tt(O, t) - tt(O, e) : 0 : 4 & i ? -1 : 1)
                    }
                    : function(t, e) {
                        if (t === e)
                            return R = !0,
                ...
                e.matchesSelector = function(t, i) {
                    if ((t.ownerDocument || t) !== E && D(t),
                    i = i.replace(ht, "='$1']"),
                    b.matchesSelector && M && (!F || !F.test(i)) && (!L || !L.test(i)))
                        try {
                            var n = j.call(t, i);
                ...
                e.contains = function(t, e) {
                    return (t.ownerDocument || t) !== E && D(t),
                    q(t, e)
                }
                ,
                e.attr = function(t, e) {
                ...
                w = e.selectors = {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function(t) {
                            var e, i = !t[6] && t[2];
                            return dt.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && ft.test(i) && (e = C(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                            t[2] = i.slice(0, e)),
                            t.slice(0, 3))
                        }
                    },
                    filter: {
                        ...
                        ATTR: function(t, i, n) {
                            return function(r) {
                                var s = e.attr(r, t);
                                return null == s ? "!=" === i : i ? (s += "",
                                "=" === i ? s === n : "!=" === i ? s !== n : "^=" === i ? n && 0 === s.indexOf(n) : "*=" === i ? n && s.indexOf(n) > -1 : "$=" === i ? n && s.slice(-n.length) === n : "~=" === i ? (" " + s.replace(at, " ") + " ").indexOf(n) > -1 : "|=" === i ? s === n || s.slice(0, n.length + 1) === n + "-" : !1) : !0
                            }
                        },
                        CHILD: function(t, e, i, n, r) {
                            ...
                            : function(e, i, l) {
                                var u, c, h, f, p, d, m = s !== o ? "nextSibling" : "previousSibling", g = e.parentNode, _ = a && e.nodeName.toLowerCase(), v = !l && !a;
                                if (g) {
                                    if (s) {
                                        for (; m; ) {
                                            for (h = e; h = h[m]; )
                                    ...
                                    o && v) {
                                        ...
                                        p = u[0] === B && u[1],
                                        f = u[0] === B && u[2],
                                        h = p && g.childNodes[p]; h = ++p && h && h[m] || (f = p = 0) || d.pop(); )
                                            if (1 === h.nodeType && ++f && h === e) {
                                                c[t] = [B, p, f];
                                                break
                                            }
                                    } else if (v && (u = (e[z] || (e[z] = {}))[t]) && u[0] === B)
                                        f = u[1];
                                    else
                                        for (; (h = ++p && h && h[m] || (f = p = 0) || d.pop()) && ((a ? h.nodeName.toLowerCase() !== _ : 1 !== h.nodeType) || !++f || (v && ((h[z] || (h[z] = {}))[t] = [B, f]),
                                        h !== e)); )
                                            ;
                                    return f -= r,
                                    f === n || f % n === 0 && f / n >= 0
                ...
                P = e.select = function(t, e, i, n) {
                    ...
                    1 === h.length) {
                        ...
                        s.length > 2 && "ID" === (o = s[0]).type && b.getById && 9 === e.nodeType && M && w.relative[s[1].type]) {
                            if (e = (w.find.ID(o.matches[0].replace(bt, wt), e) || [])[0],
                            !e)
                                return i;
                            u && (e = e.parentNode),
                    ...
                    return (u || k(t, h))(n, e, !M, i, yt.test(t) && c(e.parentNode) || e),
                    i
                }
                ,
                b.sortStable = z.split("").sort($).join("") === z,
            ...
            J.extend({
                ...
                when: function(t) {
                    var e, i, n, r = 0, s = X.call(arguments), o = s.length, a = 1 !== o || t && J.isFunction(t.promise) ? o : 0, l = 1 === a ? t : J.Deferred(), u = function(t, i, n) {
                        return function(r) {
                            i[t] = this,
                            n[t] = arguments.length > 1 ? X.call(arguments) : r,
            ...
            J.event = {
                ...
                add: function(t, e, i, n, r) {
                    ...
                    if (g)
                        ...
                        u = e.length; u--; )
                            ...
                            (f = l[p]) || (f = l[p] = [],
                            f.delegateCount = 0,
                            h.setup && h.setup.call(t, n, d, o) !== !1 || t.addEventListener && t.addEventListener(p, o, !1)),
                    ...
                    if (g && (l = g.events)) {
                        ...
                        u = e.length; u--; )
                            ...
                            p) {
                                ...
                                o && !f.length && (h.teardown && h.teardown.call(t, d, g.handle) !== !1 || J.removeEvent(t, p, g.handle),
                                delete l[p])
                            } else
                                for (p in l)
                ...
                trigger: function(e, i, n, r) {
                    var s, o, a, l, u, c, h, f = [n || Z], p = G.call(e, "type") ? e.type : e, d = G.call(e, "namespace") ? e.namespace.split(".") : [];
                    if (o = a = n = n || Z,
                    3 !== n.nodeType && 8 !== n.nodeType && !At.test(p + J.event.triggered) && (p.indexOf(".") >= 0 && (d = p.split("."),
                    p = d.shift(),
                    d.sort()),
                    u = p.indexOf(":") < 0 && "on" + p,
                    ...
                    r || !h.trigger || h.trigger.apply(n, i) !== !1)) {
                        if (!r && !h.noBubble && !J.isWindow(n)) {
                            ...
                            At.test(l + p) || (o = o.parentNode); o; o = o.parentNode)
                                f.push(o),
                                a = o;
                        ...
                        for (s = 0; (o = f[s++]) && !e.isPropagationStopped(); )
                            ...
                            c = (_t.get(o, "events") || {})[e.type] && _t.get(o, "handle"),
                            c && c.apply(o, i),
                            c = u && o[u],
                            c && c.apply && J.acceptData(o) && (e.result = c.apply(o, i),
                            e.result === !1 && e.preventDefault());
                        return e.type = p,
                        r || e.isDefaultPrevented() || h._default && h._default.apply(f.pop(), i) !== !1 || !J.acceptData(n) || u && J.isFunction(n[p]) && !J.isWindow(n) && (a = n[u],
                        a && (n[u] = null ),
                        J.event.triggered = p,
                        n[p](),
                ...
                dispatch: function(t) {
                    t = J.event.fix(t);
                    var e, i, n, r, s, o = [], a = X.call(arguments), l = (_t.get(this, "events") || {})[t.type] || [], u = J.event.special[t.type] || {};
                    if (a[0] = t,
                ...
                fix: function(t) {
                    ...
                    for (o || (this.fixHooks[r] = o = Pt.test(r) ? this.mouseHooks : kt.test(r) ? this.keyHooks : {}),
            ...
            J.extend({
                ...
                buildFragment: function(t, e, i, n) {
                    for (var r, s, o, a, l, u, c = e.createDocumentFragment(), h = [], f = 0, p = t.length; p > f; f++)
                        ...
                        r || 0 === r)
                            if ("object" === J.type(r))
                                J.merge(h, r.nodeType ? [r] : r);
                            else if (Et.test(r)) {
                                for (s = s || c.appendChild(e.createElement("div")),
                                o = (Dt.exec(r) || ["", ""])[1].toLowerCase(),
                                a = qt[o] || qt._default,
                                s.innerHTML = a[1] + r.replace(Rt, "<$1></$2>") + a[2],
                                u = a[0]; u--; )
                                    s = s.lastChild;
                                J.merge(h, s.childNodes),
                                s = c.firstChild,
                                s.textContent = ""
                            } else
            ...
            J.fn.extend({
                ...
                domManip: function(t, e) {
                    ...
                    if (m || u > 1 && "string" == typeof f && !Q.checkClone && Mt.test(f))
                    ...
                    n)) {
                        ...
                        if (s)
                            ...
                            l = 0; s > l; l++)
                                o = r[l],
                                Lt.test(o.type || "") && !_t.access(o, "globalEval") && J.contains(a, o) && (o.src ? J._evalUrl && J._evalUrl(o.src) : J.globalEval(o.textContent.replace(jt, "")))
                    }
                    return this
                }
            }),
            ...
            var zt, It = {}, Bt = /^margin/, Ht = new RegExp("^(" + bt + ")(?!px)[a-z%]+$","i"), Xt = function(e) {
            ...
            J.extend({
                ...
                style: function(t, e, i, n) {
                    if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                        ...
                        "string" === s && (r = $t.exec(i)) && (i = (r[1] + 1) * r[2] + parseFloat(J.css(t, e)),
                        s = "number"),
                        null != i && i === i && ("number" !== s || J.cssNumber[a] || (i += "px"),
            ...
            J.fx.step = {};
            var Qt, Zt, Kt = /^(?:toggle|show|hide)$/, Jt = new RegExp("^(?:([+-])=|)(" + bt + ")([a-z%]*)$","i"), te = /queueHooks$/, ee = [E], ie = {
                "*": [function(t, e) {
            ...
            J.extend({
                attr: function(t, e, i) {
                    ...
                    if (t && 3 !== s && 8 !== s && 2 !== s)
                        return typeof t.getAttribute === Ct ? J.prop(t, e, i) : (1 === s && J.isXMLDoc(t) || (e = e.toLowerCase(),
                ...
                toggleClass: function(t, e) {
                    ...
                    return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : J.isFunction(t) ? this.each(function(i) {
                        ...
                        if ("string" === i)
                            ...
                            (i === Ct || "boolean" === i) && (this.className && _t.set(this, "__className__", this.className),
            ...
            J.fn.extend({
                val: function(t) {
                    var e, i, n, r = this[0];
                    {
                        ...
                        if (r)
                            return e = J.valHooks[r.type] || J.valHooks[r.nodeName.toLowerCase()],
            ...
            J.extend({
                ...
                ajax: function(t, e) {
                    function i(t, e, i, o) {
                        ...
                        i && (v = q(h, b, i)),
                        v = z(h, v, b, l),
                        l ? (h.ifModified && (x = b.getResponseHeader("Last-Modified"),
                        x && (J.lastModified[r] = x),
                        x = b.getResponseHeader("etag"),
                        x && (J.etag[r] = x)),
                        204 === t || "HEAD" === h.type ? w = "nocontent" : 304 === t ? w = "notmodified" : (w = v.state,
                        c = v.data,
                        _ = v.error,
                        l = !_)) : (_ = w,
                        (t || !w) && (w = "error",
                        ...
                        b.status = t,
                        b.statusText = (e || w) + "",
                        l ? d.resolveWith(f, [c, w, b]) : d.rejectWith(f, [b, w, _]),
                        b.statusCode(g),
                        g = void 0,
                        u && p.trigger(l ? "ajaxSuccess" : "ajaxError", [b, h, l ? c : _]),
                        m.fireWith(f, [b, w]),
                        u && (p.trigger("ajaxComplete", [b, h]),
                        --J.active || J.event.trigger("ajaxStop")))
                    }
                    "object" == typeof t && (e = t,
                    t = void 0),
                    e = e || {};
                    var n, r, s, o, a, l, u, c, h = J.ajaxSetup({}, e), f = h.context || h, p = h.context && (f.nodeType || f.jquery) ? J(f) : J.event, d = J.Deferred(), m = J.Callbacks("once memory"), g = h.statusCode || {}, _ = {}, v = {}, y = 0, x = "canceled", b = {
                        readyState: 0,
                    ...
                    if (d.promise(b).complete = m.add,
                    b.success = b.done,
                    b.error = b.fail,
                    h.url = ((t || h.url || be) + "").replace(he, "").replace(ge, we[1] + "//"),
                    h.type = e.method || e.type || h.method || h.type,
                    h.dataTypes = J.trim(h.dataType || "*").toLowerCase().match(pt) || [""],
                    null == h.crossDomain && (l = _e.exec(h.url.toLowerCase()),
                    h.crossDomain = !(!l || l[1] === we[1] && l[2] === we[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (we[3] || ("http:" === we[1] ? "80" : "443")))),
                    ...
                    delete h.data),
                    h.cache === !1 && (h.url = fe.test(r) ? r.replace(fe, "$1_=" + ue++) : r + (ce.test(r) ? "&" : "?") + "_=" + ue++)),
                    h.ifModified && (J.lastModified[r] && b.setRequestHeader("If-Modified-Since", J.lastModified[r]),
                    ...
                    b.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + xe + "; q=0.01" : "") : h.accepts["*"]);
                    for (c in h.headers)
                        b.setRequestHeader(c, h.headers[c]);
                    if (h.beforeSend && (h.beforeSend.call(f, b, h) === !1 || 2 === y))
                        return b.abort();
                    x = "abort";
                    for (c in {
                        success: 1,
            ...
            Q.cors = !!De && "withCredentials"in De,
            Q.ajax = De = !!De,
                    ...
                    send: function(i, n) {
                        ...
                        e = function(t) {
                            return function() {
                                ...
                                "abort" === t ? s.abort() : "error" === t ? n(s.status, s.statusText) : n(Re[s.status] || s.status, s.statusText, "string" == typeof s.responseText ? {
                                    text: s.responseText
            ...
            J.ajaxPrefilter("json jsonp", function(e, i, n) {
                ...
                a ? e[a] = e[a].replace(Ne, "$1" + r) : e.jsonp !== !1 && (e.url += (ce.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
            ...
            J.offset = {
                setOffset: function(t, e, i) {
                    var n, r, s, o, a, l, u, c = J.css(t, "position"), h = J(t), f = {};
            ...
            J.fn.extend({
                offset: function(t) {
                    ...
                    if (s)
                        ...
                        J.contains(e, n) ? (typeof n.getBoundingClientRect !== Ct && (r = n.getBoundingClientRect()),
                        i = B(s),
                        {
            ...
            J.each(["top", "left"], function(t, e) {
                J.cssHooks[e] = w(Q.pixelPosition, function(t, i) {
                    return i ? (i = b(t, e),
                    Ht.test(i) ? J(t).position()[e] + "px" : i) : void 0
                })
            }),
            J.each({
                Height: "height",
    ...
    5: [function(t, e, i) {
        !function(t, n) {
            ...
            function t(t, e) {
                if (e) {
                    var i = !t.getAttribute("viewBox") && e.getAttribute("viewBox")
                      ...
                      , r = e.cloneNode(!0);
                    for (i && t.setAttribute("viewBox", i); r.childNodes.length; )
            ...
            function i(i) {
                ...
                i = i || {};
                var r, s = document.getElementsByTagName("use"), o = i.fallback || function(t) {
                    return t.replace(/\?[^#]+/, "").replace("#", ".").replace(/^\./, "") + ".png" + (/\?[^#]+/.exec(t) || [""])[0]
                }
                ;
                r = "nosvg"in i ? i.nosvg : /\bMSIE [1-8]\b/.test(navigator.userAgent),
                r && (document.createElement("svg"),
